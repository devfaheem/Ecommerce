            ...
            <div class="col-md-6 col-12 d-flex">
                <div class="ee-login">
                    ...
                    <form action="{{ route('home.login') }}" method="post">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12 mb-30"><input type="email" name="email" id="email" placeholder="Type your email address" required=""></div>
                            <div class="col-12 mb-20"><input type="password" name="password" id="password" placeholder="Enter your passward" required=""></div>
                    ...
                    <h4>Don’t have account? please click <a href="{{ route('home.register') }}">Register</a></h4>
